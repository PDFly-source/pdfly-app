...
export const Logo: React.FC<LogoProps> = ({
  ...
  const content = (
    ...
    >
      {/* Official PDFMiniFly Logo Emblem (new approved brand mark) */}
      <div
      ...
      {variant !== 'icon' && (
        <div className="flex flex-col leading-none">
          <div className="flex items-center tracking-tight font-extrabold font-sans">
            ...
            {/* "MiniFly" in Black (Cream in dark mode) */}
            <span
              className={`${textSize} font-black text-[#1A1416] dark:text-[#F7F1E8] tracking-tight`}
              style={{
                fontFamily: 'system-ui, -apple-system, sans-serif',
              }}
            >
            ...
            {/* Gold Feather Wing Accent (official logo flourish) */}
            <svg
              viewBox="0 0 24 16"
              fill="none"
