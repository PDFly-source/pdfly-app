...
export const PWAInstallButton: React.FC<Props> = ({ variant = 'nav', onShowGuide }) => {
  ...
  if (isInstallable) {
    if (variant === 'dedicated') {
      return (
        ...
        >
          ...
          <span>{isInstalling ? 'Opening Browser Prompt...' : 'Install PDFly'}</span>
        </button>
      );
    }
    ...
    return (
      <button
        ...
        title="Install PDFly on your device"
      >
    ...
    if (variant === 'dedicated') {
      return (
        ...
        >
          ...
          <span>Add PDFly to Home Screen</span>
        </button>
      );
    }
  ...
  // Never disable permanently! Keep primary CTA as "Install PDFly"
  if (variant === 'dedicated') {
    return (
      <button
